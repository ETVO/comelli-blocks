...
// Core constants 
define("PLUGIN_DIR", plugin_dir_path(__DIR__) . "comelli-blocks/");
define("PLUGIN_URL", plugins_url("comelli-blocks/"));
define("PLUGIN_CLASS", "Comelli_Blocks");
